...
class TestResourceRouter:
    ...
    async def test_create_resource(self):
        ...
        api_body = {"title": "Test Resource", "created_by_id": 1, "process_ids": []}
        response = await self.client.post("/api/v1/resources/", json=api_body)
    ...
    async def test_update_resource(self):
        ...
        response = await self.client.put(f"/api/v1/resources/{resource_id}", json=update_body)
    ...
    async def test_delete_resource(self):
        ...
        assert delete_data["message"] == "Resource deleted successfully"
