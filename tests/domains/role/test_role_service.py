...
class TestRoleService:
    ...
    async def test_get_roles(self):
        ...
        role_data = RoleCreate(title="Role for List Test", created_by_id=1, process_ids=[])
    ...
    async def test_get_role_by_id(self):
        ...
        role_data = RoleCreate(title="Role for Get Test", created_by_id=1, process_ids=[1])
        created_role = await self.service.create_role(role_data)
    ...
    async def test_update_role(self):
        ...
        role_data = RoleCreate(title="Original Role Title", created_by_id=1, process_ids=[])
        created_role = await self.service.create_role(role_data)
        role_id = created_role.id
    ...
    async def test_update_role_invalid_relationships(self):
        ...
        # Create a role to update
        role_data = RoleCreate(title="Role for Invalid Update", created_by_id=1, process_ids=[])
        created_role = await self.service.create_role(role_data)
        role_id = created_role.id
    ...
    async def test_delete_role(self):
        ...
        role_data = RoleCreate(title="Role to Delete", created_by_id=1, process_ids=[])
        created_role = await self.service.create_role(role_data)
        role_id = created_role.id
